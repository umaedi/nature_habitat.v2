...
class User_model extends CI_Model
{
    ...
    {
        $brand = $this->input->post('barnd');
        $company = $this->input->post('cpmpany');
        $country   = $this->input->post('country');
        $whatsapp  = $this->input->post('whatsapp');
        $phone     = $this->input->post('phone');
        $website   = $this->input->post('website');
        $busines   = $this->input->post('busines');
        $detail_order  = $this->input->post('detail-order');
        ...
        $region_otehr  = $this->input->post('region-other');
        $flaship_store = $this->input->post('flaship-store');
        $indoor        = $this->input->post('indoor');
        $outdoor       = $this->input->post('outdoor');
        $buy_form1    = $this->input->post('buy-form1');
        $buy_form2     = $this->input->post('buy-form2');
